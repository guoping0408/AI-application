...
To utilize our models trained on DIGITS, we have to install DeepStream SDK on our TX2. First, download the DeepStream SDK version 1.5 from the website

[https://developer.nvidia.com/embedded/deepstream-on-jetson-downloads](https://developer.nvidia.com/embedded/deepstream-on-jetson-downloads)
